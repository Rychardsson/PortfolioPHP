...
<div class="flex flex-col md:flex-row items-center justify-between px-8 py-20">
  <div class="md:w-1/2 space-y-6">
    ...
    <div class="space-x-4">
      <a href="{{ route('projetos') }}" class="bg-white text-black px-4 py-2 rounded-full font-bold">Portfólio</a>
      <a href="/assets/cv.pdf" class="underline">Curriculum Vitae</a>
    </div>
  </div>

  <div class="md:w-1/2 mt-10 md:mt-0 text-center">
    <img src="/assets/img/rychardsson.png" alt="Rychardsson" class="rounded shadow-lg max-w-xs mx-auto border">
